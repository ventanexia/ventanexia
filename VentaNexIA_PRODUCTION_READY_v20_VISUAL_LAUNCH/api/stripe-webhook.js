...
async function resolveTenantId({solutionRequestId="",subscriptionId="",customerId=""}={}){
...
export default async function handler(req,res){
  ...
  try{
    ...
    const subscriptionId=String(obj.subscription||obj.id&&event.type.startsWith("customer.subscription.")?obj.id:"");
    const customerId=String(obj.customer||"");
    const tenantId=await resolveTenantId({solutionRequestId,subscriptionId,customerId});
