(()=>{
  ...
  const GUIDED_AGENT_FORMS={
    ...
    orders:{
      subtitle:'Recoge pedidos del correo o de páginas privadas, asigna un número interno a cada pedido, comprueba stock y coordina automáticamente con Compras y el cliente.',
