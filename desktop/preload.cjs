...
contextBridge.exposeInMainWorld('vnx',{
  ...
  shopifyReplenishmentSummary:(shop,options={})=>ipcRenderer.invoke('shopify:replenishment-summary',{shop,force:options?.force!==false,targetDays:options?.targetDays,noHistoryMin:options?.noHistoryMin}),
  portalReplenishmentSummary:(id,options={})=>ipcRenderer.invoke('portal:replenishment-summary',{id,force:Boolean(options?.force),targetDays:options?.targetDays,noHistoryMin:options?.noHistoryMin}),
