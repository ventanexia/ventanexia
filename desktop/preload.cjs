...
contextBridge.exposeInMainWorld('vnx',{
  ...
  shopifyReplenishmentSummary:(shop,options={})=>ipcRenderer.invoke('shopify:replenishment-summary',{shop,force:options?.force!==false}),
  portalReplenishmentSummary:(id,options={})=>ipcRenderer.invoke('portal:replenishment-summary',{id,force:Boolean(options?.force)}),
