...
contextBridge.exposeInMainWorld('vnx',{
  ...
  directionSummary:(options={})=>ipcRenderer.invoke('direction:summary',options),
  directionEmployees:(options={})=>ipcRenderer.invoke('direction:employees',options),
  directionSaveEmployee:(payload={})=>ipcRenderer.invoke('direction:save-employee',payload),
  directionCreateTask:(payload={})=>ipcRenderer.invoke('direction:create-task',payload),
  directionUpdateTask:(id,patch={})=>ipcRenderer.invoke('direction:update-task',{id,patch}),
  directionAddEvent:(taskId,event={})=>ipcRenderer.invoke('direction:add-event',{taskId,event}),
  directionResolveTask:(taskId,payload={})=>ipcRenderer.invoke('direction:resolve-task',{taskId,...payload}),
  directionSettings:(payload=null)=>ipcRenderer.invoke('direction:settings',payload),
  directionAiQueue:(options={})=>ipcRenderer.invoke('direction:ai-queue',options),
