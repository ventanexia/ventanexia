...
function createDirectionDemo({businessId='demo-business'}={}){
  ...
  const laura=seedEmployee(d,{id:'demo-laura',employeeCode:'DEMO-COM-001',name:'Laura Gómez',role:'Comercial B2B',email:'laura.demo@empresa-ejemplo.local',businessId},
    ...
    {declaredStrengths:['Comunicación con clientes','Seguimiento comercial'],roleInterests:['Gestión de grandes cuentas','Desarrollo de negocio'],preferredAutonomy:'Alta con objetivos claros',collaborationPreference:'Coordinación frecuente con Administración y Logística',workContext:'DEMO · contexto profesional ficticio.'});
  ...
  const carlos=seedEmployee(d,{id:'demo-carlos',employeeCode:'DEMO-ADM-002',name:'Carlos Martín',role:'Administración',email:'carlos.demo@empresa-ejemplo.local',businessId},
    ...
    {declaredStrengths:['Orden documental','Seguimiento de incidencias'],roleInterests:['Administración comercial','Reporting'],preferredAutonomy:'Media',collaborationPreference:'Procesos claros y coordinación por prioridades',workContext:'DEMO · contexto profesional ficticio.'});
  ...
  const marta=seedEmployee(d,{id:'demo-marta',employeeCode:'DEMO-ATC-003',name:'Marta Ruiz',role:'Atención al cliente',email:'marta.demo@empresa-ejemplo.local',businessId},
    ...
    {declaredStrengths:['Escucha','Explicación de soluciones'],roleInterests:['Customer Success','Coordinación de servicio'],preferredAutonomy:'Media-alta',collaborationPreference:'Trabajo transversal con ventas y operaciones',workContext:'DEMO · contexto profesional ficticio.'});
