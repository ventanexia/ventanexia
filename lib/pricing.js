...
export function recommendPlan(blueprint={}){
  ...
  const names={start:"VNX Inicio",core:"VNX Crecimiento",scale:"VNX Empresa"};
  const exceedsScale=agents>12||integrations>10;
  return {
    key,name:names[key],monthly:p.monthly,
    includedAgents:p.agents,includedIntegrations:p.integrations,
    detectedAgents:agents,detectedIntegrations:integrations,
    exceedsScale,
    reason:exceedsScale
      ?"Tu caso necesita más capacidad de la incluida de serie. Empezamos por VNX Empresa y revisamos contigo la ampliación necesaria antes de contratar nada extra."
