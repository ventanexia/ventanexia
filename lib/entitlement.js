...
export async function activatePaid(tenantId,{customerId=null,subscriptionId=null,invoiceId=null,planKey="core",featurePolicy=null}={}){
  const payload={
    ...
    feature_policy:{mode:"paid",external_writes:true,bulk_outbound:"policy_controlled",...(featurePolicy||{})}
  };
  const ent=await getEntitlement(tenantId);
