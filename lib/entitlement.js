...
export async function startTrial(tenantId,planKey="core"){
  ...
  const payload={
    ...
    feature_policy:{
      ...
      external_writes:false,bulk_outbound:false,financial_commitments:false,
...
export async function activatePaid(tenantId,{customerId=null,subscriptionId=null,invoiceId=null,planKey=null,featurePolicy=null}={}){
  ...
  const payload={
    ...
    feature_policy:{mode:"paid",external_writes:true,bulk_outbound:"policy_controlled",...previousPolicy,...(featurePolicy||{})}
  };
